...
weaviate_admin_api_key = os.environ["WEAVIATE_ADMIN_KEY"] if use_local else os.environ["WEAVIATE_OPENAI_ADMIN_KEY"]
weaviate_url = os.environ["LOCAL_EMBEDDING_WEAVIATE_URL"] if use_local else os.environ["WEAVIATE_URL"]
